...
function App() {
  ...
  const isLoginRoute = location.pathname === '/login' || location.pathname === '/complete-profile' || location.pathname === '/PasswordLogin' || location.pathname === '/reset-password';
    ...
    <div className="premium-container relative min-h-screen">
      ...
      <main className={isLoginRoute ? 'p-0 max-w-none' : ''}>
        <Routes>
          ...
          <Route path="/PasswordLogin" element={<MasterRecovery />} />
